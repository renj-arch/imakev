...
scenes = [
    ...
    (4, "Timeline - buildings begin fading", [
        E("building",0.25,0.7,3.5,width=40,height=60), E("building",0.5,0.65,4.0,width=45,height=70), E("building",0.75,0.7,3.5,width=40,height=60),
    ], {"sky_top":(160,180,200),"sky_bot":(180,200,220),"ground":(100,120,90)}),
    (5, "Workers stop building monuments", [
        E("human",0.3,0.72,3.0,pose="standing",gender="man"),
        E("human",0.45,0.7,3.0,pose="standing",gender="man"),
        E("pyramid",0.72,0.78,3.5,steps=3),
    ], {"sky_top":(150,170,190),"sky_bot":(170,190,210),"ground":(90,110,80)}),
    (6, "Abandoned throne with leaves", [
        E("throne",0.5,0.72,4.0), E("leaf",0.15,0.3,2.0), E("leaf",0.85,0.25,1.5),
    ], {"sky_top":(130,140,150),"sky_bot":(160,170,180),"ground":(80,80,70)}),
    (7, "War - two cities, warriors, fire", [
        E("pyramid",0.2,0.75,4.0,steps=4), E("pyramid",0.8,0.75,4.0,steps=4),
        E("human",0.35,0.7,3.0,pose="fighting_stance",gender="man",mood="angry"),
        E("human",0.65,0.7,3.0,pose="fighting_stance",gender="man",mood="angry"),
        E("fire",0.5,0.45,3.0),
    ], {"sky_top":(100,90,80),"sky_bot":(140,120,100),"ground":(100,70,50)}),
    (8, "Drought - enlarged sun, cracked earth", [
        E("sun",0.5,0.08,6.0), E("cracked_ground",0.5,0.72,10,height=3),
    ], {"sky_top":(220,180,140),"sky_bot":(255,220,180),"ground":(180,150,100),"horizon":0.45}),
    (9, "Failed crops - wilting plants, harsh sun", [
        E("tree",0.3,0.72,3.5), E("tree",0.5,0.68,4.0), E("tree",0.7,0.72,3.5),
        E("sun",0.88,0.1,4.0),
    ], {"sky_top":(180,200,180),"sky_bot":(200,220,200),"ground":(160,200,140)}),
    (10, "Food scarce - empty baskets, worried family", [
        E("basket",0.3,0.72,3.5), E("basket",0.7,0.72,3.5),
        E("human",0.4,0.68,3.5,pose="standing",gender="man",mood="sad"),
        E("human",0.6,0.7,3.0,pose="standing",gender="woman",mood="sad"),
    ], {"sky_top":(160,170,180),"sky_bot":(190,200,210),"ground":(100,100,80)}),
    (11, "City-states fight - buildings on fire", [
        E("building",0.25,0.55,3.0,width=50,height=70), E("building",0.75,0.55,3.0,width=50,height=70),
        E("fire",0.25,0.38,6.0), E("fire",0.75,0.35,6.0),
    ...
    (13, "People leaving - walking away from city", [
        E("pyramid",0.78,0.68,5.0,steps=4),
        E("human",0.18,0.68,3.5,pose="walking",gender="man"),
        E("human",0.28,0.72,2.8,pose="walking",gender="woman"),
        E("human",0.36,0.76,2.2,pose="walking",gender="child"),
        E("sun",0.88,0.2,2.5),
