...
scenes = [
    ...
    (13, "People leaving - walking away, footprints", [
        E("human",0.3,0.72,2.5,pose="walking",gender="man"),
        E("human",0.35,0.75,2.0,pose="walking",gender="woman"),
        E("human",0.4,0.78,1.5,pose="walking",gender="child"),
        E("pyramid",0.7,0.75,3.0,steps=4),
        E("footprint",0.2,0.82,2.0), E("footprint",0.25,0.85,1.8),
