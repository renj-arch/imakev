...
ELEMENT_DEFS = {
    ...
    "rat":        {"type": "rat", "scale": 1.5, "fill": [160, 140, 130]},
    "animal":     {"type": "cat", "scale": 2.5, "fill": [180, 140, 100]},
    ...
    # Egypt
    "egyptian_pyramid": {"type": "egyptian_pyramid", "scale": 3.0, "fill": [200, 175, 130]},
    "sphinx":           {"type": "sphinx", "scale": 2.5, "fill": [190, 165, 120]},
    "mummy":            {"type": "mummy_cat", "scale": 2.5, "fill": [220, 210, 190]},
    "granary":          {"type": "granary", "scale": 2.5, "fill": [170, 150, 110]},
    "pharaoh":          {"type": "human", "scale": 2.5, "fill": [80, 60, 120]},
    "papyrus":          {"type": "egyptian_art", "scale": 2.0, "fill": [200, 170, 100]},
    "cat_statue":       {"type": "cat_statue", "scale": 2.5, "fill": [50, 45, 35]},
