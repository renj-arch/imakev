...
CONCEPTS = {
    ...
    "map":        ["map", "maps", "chart", "cartography", "navigation",
                    "atlas", "globe", "compass", "india", "asia", "subcontinent",
                    "tectonic", "continent", "continental", "landmass"],
    "ship":       ["ship", "boat", "vessel", "sail", "sailboat", "yacht",
                    "canoe", "kayak", "raft", "pirate", "galleon"],
