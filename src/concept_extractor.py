...
CONCEPTS = {
    ...
    "mammoth":    ["mammoth", "mammoths", "woolly mammoth", "tusk", "tusks", "herd",
                    "herds", "megafauna", "ice age animal"],
    "extinction": ["extinct", "extinction", "last of its kind", "died out",
                    "die out", "dying out", "vanished species", "wiped out",
                    "no more", "ceased to exist", "lost forever"],
